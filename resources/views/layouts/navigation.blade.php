        ...
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex px-3 py-2 rounded-md items-center text-sm font-medium text-white border-zinc-700 bg-zinc-800 hover:text-white focus:outline-none transition duration-150 ease-in-out">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = !open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-zinc-400 hover:text-zinc-500 hover:bg-zinc-100 focus:outline-none transition duration-150 ease-in-out">
